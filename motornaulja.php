			...
			<div class="section">
				<div class="breadcrumb">
					...
					<ul>
						...
						<li>
							<a href="motornaulja.php">Proizvodjaci ulja</a>
						</li>
					</ul>
				</div>
				<div class="company">
					...
					<div>
						<section class="on-sale-prva">
							<div class="container">
								<div class="row">
									<div class="col-md-4">
										<a href="total.php"><img src="slike/motornaulja/total_logo1.jpg"></a>
									</div>
									<div class="col-md-4">
										<a href="castrol.php"><img src="slike/motornaulja/castrol_logo1.jpg"></a>
									</div>
									<div class="col-md-4">
										<a href="elf.php"><img src="slike/motornaulja/elf-logo1.jpg"></a>
									</div>
								</div>
							</div>
						</section>
