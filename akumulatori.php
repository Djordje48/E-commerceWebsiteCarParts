	...
	<div id="body">
		<div class="content">
			<div class="section">
				...
				<div class="company">
					<h2>Vrste akumulatora</h2>
					<div>
						<section class="on-sale-prva">
							<div class="container">
								<div class="row">
									<div class="col-md-4">
										<a href="bosch.php"><img src="slike/akumulatori/bosch-logo.jpg"></a>
									</div>
									<div class="col-md-4">
										<a href="energizer.php"><img src="slike/akumulatori/Energizer_logo.jpg"></a>
									</div>
									<div class="col-md-4">
										<a href="varta.php"><img src="slike/akumulatori/varta_logo.jpg"></a>
									</div>
								</div>
							</div>
						</section>
