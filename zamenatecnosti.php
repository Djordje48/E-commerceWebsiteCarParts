		...
		<div class="content">
			<div class="section">
				...
				<div class="company">
					...
					<a href="bmw.php"><img src="slike/zamena_kocione_02.jpg"></a>	
					<p>Održavanje kočionog sistema vozila, zamena svih delova i tečnosti kočionog sistema vozila</p>	
					<p>Kočionu tečnost bi trebalo na 2 godine kontrolisati i ukoliko se ukaže potreba menjati. Vremenom se tečnost razgrađuje, zbog absorbovanja vode koja snižava njenu tačku ključanja, što za posledicu ima smanjenje kočione sile.</p>
					<p>Rashladna tečnost ili antifriz sprečava zaleđivanje i pojavu korozije u hladnjaku. Kako se to ne bi dogodilo prema savetima proizvođača neophodno je vršiti godišnje kontrole i zamenu u intervalu od 2 do 6 godina. U suprotnom, jedna od posledica koja se može javiti je curenje hladnjaka.</p>
