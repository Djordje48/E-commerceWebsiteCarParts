			...
			<div class="section">
				<div class="breadcrumb">
					...
					<ul>
						...
						<li>
							<a href="delovi.php">Marke automobila</a>
						</li>
					</ul>
				</div>
				<div class="company">
					...
					<div>
						<section class="on-sale-prva">
							<div class="container">
								<div class="row">
									<div class="col-md-4">
										<a href="bmw.php"><img src="slike/delovi logo/bmw-logos-2.jpg"></a>
									</div>
									<div class="col-md-4">
										<a href="mercedes.php"><img src="slike/delovi logo/mercedess.jpg"></a>
									</div>
									<div class="col-md-4">
										<a href="volkswagen.php"><img src="slike/delovi logo/volkswagen.png"></a>
									</div>
								</div>
							</div>
						</section>
			...
			<div class="sidebar">
				<div class="navigation">
					...
					<ul>
						...
						<li>
							<a href="bmw.php">Delovi za bmw</a>
						</li>
						<li>
							<a href="mercedes.php">Delovi za mercedes</a>
						</li>
						<li>
							<a href="varta.php">Delovi za volkswagen</a>
						</li>
					</ul>
				</div>
			</div>
