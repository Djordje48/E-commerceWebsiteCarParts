	...
	<div id="body">
		<div class="content">
			<div class="section">
				...
				<div class="company">
					<h2>Zamena trapa i kocionog sistema</h2>	
					<a href="bmw.php"><img src="slike/delovi_trapa_02.jpg"></a>	
					<p>Trap na vozilu sadrži mnoge komponente (amortizeri, šolje amortizera, krajevi spona, stabilizatori, gumice balans štangle, jabučice, sferni zglobovi, ležajevi) važne za bezbedno upravljanje vozilom. Kao i ostali delovi na vozilu, delovi trapa su podložni habanju i oštećenu u eksploataciji, i neophodno ih je menjati. Nakon toga, u našim servisima možemo ponuditi i GEOMETRIJSKO CENTRIRANJE TRAPA-REGLAŽU.</p>	
					<a><img src="slike/delovi_trapa_01.jpg"></a>
					<p>Kočioni sistem - pločice, paknovi, diskovi, kočioni cilindri, šape, kočiona creva - kao segmentu vrlo važnom za bezbednost u saobraćaju, poklanjamo posebnu pažnju i nudimo usluge održavanja. OZRAČIVANJE ILI ISPUŠTANJE VAZDUHA IZ SISTEMA sledi nakon zamene delova kočionog sistema ili nezavisno od samog procesa zamene.</p>
